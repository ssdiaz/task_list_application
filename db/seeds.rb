...
# task_joe = Task.create(name: "Clean Room", description: "Need to clean out desk draws", priority: "low")
# joe.tasks.push(task_joe)

# task_joe_2 = Task.create(name: "Eat Dinner", description: "I'm hungry!", priority: "medium")
